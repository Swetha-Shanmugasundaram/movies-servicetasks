...
//       try{
           responseEntity = new ResponseEntity<Movie>(movieService.addMovie(movie),HttpStatus.CREATED);
//       }
//       catch (Exception me){
//           responseEntity =new ResponseEntity<String>(me.getMessage(),HttpStatus.CONFLICT);
//       }
    ...
    public ResponseEntity<List<Movie>> findByName(@PathVariable String name) throws MovieNotFoundException {
        ResponseEntity responseEntity;
//        try{
            responseEntity = new ResponseEntity<List<Movie>>(movieService.findByName(name),HttpStatus.CREATED);
//        }
//        catch (Exception me){
//            responseEntity =new ResponseEntity<String>(me.getMessage(),HttpStatus.CONFLICT);
//        }
